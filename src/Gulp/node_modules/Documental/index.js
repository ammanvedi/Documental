...
var DocumentationBuilder = ( function(){

	//define gulp tasks as functions that can be called from within the Documental
	//library, which can build the documentation site when the

	var builder = {};


	builder.concatFiles = function( ) {
...
var docTask = function( gulp ) {

	gulp.task('docsfromgulpfile', function () {
...
var Documental = ( function ( DocSiteBuilder ) {
...
module.exports = {
	...
	DocBuilder: DocumentationBuilder,
	DocGulpTask: docTask
};