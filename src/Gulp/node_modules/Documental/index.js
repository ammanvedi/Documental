...
var Documental = ( function ( ) {
	...
	var Utils = {}, sourceMap = {}, commentsHash = {}, autocomplete = [];
	...
	Utils.exportDataToJSON = function () {
		...
		var outPath = config && config.jsonOutput ? process.cwd() + '/' + config.jsonOutput  : process.cwd() + '/';
